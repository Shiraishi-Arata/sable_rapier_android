...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_setConstraintMotor; _env, (joint_id: jlong, axis: jint, target_pos: jdouble, stiffness: jdouble, damping: jdouble, has_max_force: jboolean, max_force: jdouble), scene, {
...
crate::jni_scene_fn_ret! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_isConstraintValid; _env, (joint_id: jlong), -> jboolean, scene, {
        let sable_data = scene.sable_data.read().unwrap();
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_getConstraintImpulses; env, (joint_id: jlong, store: JDoubleArray<'local>), scene, {
        let sable_data = scene.sable_data.read().unwrap();
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_setConstraintContactsEnabled; _env, (joint_id: jlong, enabled: jboolean), scene, {
        let mut sable_data = scene.sable_data.write().unwrap();
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_removeConstraint; _env, (joint_id: jlong), scene, {
        let mut sable_data = scene.sable_data.write().unwrap();
        let mut sim_data = scene.sim_data.write().unwrap();
...
crate::jni_scene_fn_ret! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addRotaryConstraint; _env, (id_a: jint, id_b: jint, local_x_a: jdouble, local_y_a: jdouble, local_z_a: jdouble, local_x_b: jdouble, local_y_b: jdouble, local_z_b: jdouble, axis_x_a: jdouble, axis_y_a: jdouble, axis_z_a: jdouble, axis_x_b: jdouble, axis_y_b: jdouble, axis_z_b: jdouble), -> SableJointHandle, scene, {
        let mut sable_data = scene.sable_data.write().unwrap();
        let mut sim_data = scene.sim_data.write().unwrap();
...
crate::jni_scene_fn_ret! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addFixedConstraint; _env, (id_a: jint, id_b: jint, local_x_a: jdouble, local_y_a: jdouble, local_z_a: jdouble, local_x_b: jdouble, local_y_b: jdouble, local_z_b: jdouble, local_q_x: jdouble, local_q_y: jdouble, local_q_z: jdouble, local_q_w: jdouble), -> SableJointHandle, scene, {
        let mut sable_data = scene.sable_data.write().unwrap();
        let mut sim_data = scene.sim_data.write().unwrap();
...
crate::jni_scene_fn_ret! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addGenericConstraint; _env, (id_a: jint, id_b: jint, local_x_a: jdouble, local_y_a: jdouble, local_z_a: jdouble, local_q_x_a: jdouble, local_q_y_a: jdouble, local_q_z_a: jdouble, local_q_w_a: jdouble, local_x_b: jdouble, local_y_b: jdouble, local_z_b: jdouble, local_q_x_b: jdouble, local_q_y_b: jdouble, local_q_z_b: jdouble, local_q_w_b: jdouble, locked_axes_mask: jint), -> SableJointHandle, scene, {
        let mut sable_data = scene.sable_data.write().unwrap();
        let mut sim_data = scene.sim_data.write().unwrap();
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_setConstraintFrame; _env, (joint_id: jlong, side: jint, local_x: jdouble, local_y: jdouble, local_z: jdouble, local_q_x: jdouble, local_q_y: jdouble, local_q_z: jdouble, local_q_w: jdouble), scene, {
        let mut sable_data = scene.sable_data.write().unwrap();
        let Some(joint) = sable_data.joint_set.joints.get_mut(&joint_id) else {
            return;
        };
