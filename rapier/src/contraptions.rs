...
use jni::objects::{JDoubleArray, JIntArray};
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_createKinematicContraption; _env, (mount_id: jint, id: jint, _pose: JDoubleArray<'local>), scene, {
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_setKinematicContraptionTransform; env, (id: jint, center_of_mass: JDoubleArray<'local>, pose: JDoubleArray<'local>, velocities: JDoubleArray<'local>), scene, {
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addKinematicContraptionChunkSection; env, (id: jint, x: jint, y: jint, z: jint, data: JIntArray<'local>), scene, {
...
crate::jni_scene_fn! {
    Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_removeKinematicContraption; _env, (id: jint), scene, {
        let mut sim_data = scene.sim_data.write().unwrap();
        let sim_data = &mut *sim_data;
        let mut sable_data = scene.sable_data.write().unwrap();
